      ...
      <ContentWrapper>
        <div className="flex md:flex-row container mx-auto">
          <div className="hidden lg:block p-3 mb-4 border border-[#444444] h-full fixed top-[80px] z-20 overflow-y-scroll lg:w-[260px] pb-28 text-[#FFFFFF]">
            <h2 className="text-center py-2 bg-[#0e1629] text-[#5DD9C1] hover:shadow-md hover:bg-[#1a284c] mb-2 rounded-sm">
            ...
            <div className="w-full my-2">
              <input
                ...
                className="w-full px-3 py-2 bg-transparent border border-[#959fb3] focus:border-[#0e1629] outline-none text-black placeholder-gray-700 my-2"
              />
            </div>

            <div className="w-full">
              <button
                className="w-full py-2 text-center bg-[#0e1629] text-[#5DD9C1]  hover:shadow-md hover:bg-[#1a284c] rounded-sm"
          ...
          <div className="lg:ml-[280px] border border-[#444444]">
            <h2 className="mb-2 p-2 text-black">
