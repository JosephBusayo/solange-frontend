  ...
  return (
    ...
    <div className="">
      {isLoading ? null : error ? (
        ...
        <>
          <h1 className="text-black lg:text-2xl font-bold mb-8">
            Featured Products
          </h1>
            ...
            {products.map(
              ({
                ...
                <div key={_id} className="mx-auto h-[450px] md:h-[700px]">
                  ...
                  <div className="mt-2 flex border border-[#444444] px-2 p-2 text-[#000000c3] overflow-hidden">
                    <div className="one">
                      <div className="flex gap-8 justify-between">
                        <h2 className="text-base md:text-lg font-medium text-black/80 mb-2">
                          {name.substring(0, 50)}...
                        </h2>
                        <p className="text-[#5DD9C1] text-sm md:text-base md:font-bold hidden md:flex">
                          {" "}
                          $ {price}
                        </p>
                      </div>
